    ...
    return (
        <div className="">
            {bookInfo && bookInfo.volumeInfo ? (
                <div className="relative bg-white p-3 h-full text-center flex items-center justify-center rounded hover:bg-green-0 hover:shadow transition-all duration-150 ease-in-out">
