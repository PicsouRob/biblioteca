        ...
        <div className="h-full grid grid-cols-1 lg:grid-cols-2 min-h-screen">
            ...
            <div className="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto w-full">
                    ...
                    <h2 className="text-3xl font-bold leading-tight text-primary sm:text-4xl">Crear una cuenta</h2>
                    <p
                        className="mt-2 text-base text-gray-600">
                        Ya tienes una cuenta?
                        <Link
                            href="/signin" title=""
                            className="ml-2 font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">
                            Iniciar Session
                        </Link>
                    </p>
                        ...
                        {({ values, errors, handleSubmit, handleChange, touched }) => (
                            <form onSubmit={handleSubmit} className="mt-3">
                                ...
                                <div className="space-y-5">
                                    <div>
                                        <label htmlFor="" className="text-base font-medium text-gray-900">Nombre</label>
                                        ...
                                        {touched.name && errors.name && (
                                            <p className="text-red-700 text-[14px]">{errors.name}</p>
                                        )}
                                    </div>
                                    ...
                                    <AuthSubmitButton isLoading={isLoading} text="Crear mi cuenta" />
                                </div>
                            </form>
                        )}
                    </Formik>
