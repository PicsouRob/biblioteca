    ...
    <section className="">
      <div className="relative py-12 bg-white sm:py-16 lg:py-20">
        ...
        <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-lg md:max-w-2xl mx-auto text-center xl:max-w-3xl">
            ...
            <form action="#" className="max-w-xl flex flex-col sm:flex-row items-center mx-auto mt-6 gap-3">
              <div className="rounded flex-1">
                <label htmlFor="" className="sr-only"> Buscar </label>
                <div className="relative rounded flex items-center gap-2 bg-white">
                  ...
                  <input type="text" name="value" id="value"
                    ...
                    className="block w-full py-2 pl-10 pr-4 rounded text-base placeholder:text-sm font-normal leading-7 text-gray-900 placeholder-gray-500 bg- border border-white focus:ring-0 focus:border-white focus:ring-offset-0"
                  />
              ...
              <Link
                href={`/search?input=${value}`}
                className="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 rounded text-sm font-bold tracking-widest text-white uppercase transition-all duration-200 bg-orange-800 border border-transparent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-white hover:bg-orange-900"
              >
                Buscar
              </Link>
            </form>
